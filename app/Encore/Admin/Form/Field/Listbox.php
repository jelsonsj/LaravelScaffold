...
class Listbox extends MultipleSelect
{
    ...
    protected static $css = [
        '/resources/assets/bootstrap-duallistbox/dist/bootstrap-duallistbox.min.css',
    ];

    protected static $js = [
        '/resources/assets/bootstrap-duallistbox/dist/jquery.bootstrap-duallistbox.min.js',
    ];
