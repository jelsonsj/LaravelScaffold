...
class MultipleFile extends Field
{
    ...
    protected static $css = [
        '/resources/assets/bootstrap-fileinput/css/fileinput.min.css?v=4.3.7',
    ];
     ...
     */
    protected static $js = [
        '/resources/assets/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js?v=4.3.7',
        '/resources/assets/bootstrap-fileinput/js/fileinput.min.js?v=4.3.7',
    ];
